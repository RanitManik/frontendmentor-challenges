...
Your challenge is to build out this advice generator app from the designs provided in the starter code.
...
- Solution
  URL: [click here to see the solution](https://www.frontendmentor.io/solutions/advicegeneratorapp-using-html5-tailwindcss-and-javascript-ypU9wOq5Bd)
- Live Site
  URL: [click here to see the Live Site](https://ranitmanik.github.io/frontendmentor-challenges/FrontendMentor23%E2%80%94advice-generator-app/index.html)
